...
What I enjoyed less was the peewee interface, but it is like all python package
it just takes a bit of time to get use to the syntax. I had some troubles when formatting to insert into the database.
For instance, it only accepts a specific input that is done using the argument orient=index in the pandas function.
And I faced some problems in the configuration of the database when trying to insert for the first time.
But after I got used to it quite fast.

I really enjoyed doing this exercise, I thought it was well prepared and covered many aspects.
Moreover, the data provided was interesting to work with. I am also glad I got to learn about Pipenv.
Finally doing this exercise really confirmed my motivation to join Arthena:)
